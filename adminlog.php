...
<h1 class="text-center my-4 text-primary">Admin Dashboard</h1>
...
<button type="" class="btn btn-secondary my-3">For Checking Purpose I disclose that Admin email is - simantapatowary963@gmail.com & Password is - 123 otherwise only Admin will know Admin Credentials</button>
<div class="footer">
